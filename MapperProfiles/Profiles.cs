...
public class Profiles : Profile
{
    public Profiles()
    {
        ...
        CreateMap<Rental, RentalOutput>().ForMember(x => x.Inventory_Film_Title, cfg => cfg.
        MapFrom(src => src.Inventory.Film.Title))
        .ForMember(x => x.Customer_First_Name, cfg => cfg.MapFrom(src => src.Customer.First_name))
        .ForMember(x => x.Customer_Last_Name, cfg => cfg.MapFrom(src => src.Customer.Last_name))
        .ForMember(x => x.DescricaoSituacao, cfg => cfg.MapFrom(src => src.Situacao.TipoSituacaoToString()));
